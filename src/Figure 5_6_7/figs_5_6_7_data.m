...
%
% Description: generates and saves the data for Figures 5, 6 and 7.
%-------------------------------------------------------------------------%
% Inputs:
% fig_num - figure number (either 5, 6 or 7)
% row_num - row number (either 1 or 2)
% col_num - column number (either 1 or 2)
%-------------------------------------------------------------------------%

function figs_5_6_7_data(fig_num,row_num,col_num)
...
ir_domain      = 1;                   % ir_domain - 1: Hypercube| 2: Anullus | 3: Linear const. | 4: Prism 
...
for l = 1:num_cases
    ...
    for i = 1:num_m
        ...
        parfor t = 1:num_trials
            ...
            disp(['Figure','_',num2str(fig_num),'_',num2str(row_num),'_',num2str(col_num),space,'dimension = ',num2str(d),space,...
...
%%% Save data %%%
clear A_err_grid Q_err_grid R b_err_grid err_grid A b eta stat W w opt_mu opt_w theta

save(['../../data/Figure 5_6_7/',fig_name])
