...
%
% Description: generates the plots for Figure 11, 12 and 13
%-------------------------------------------------------------------------%
...
for fig_num = 11:13
    for row_num = 1:2
        for col_num = 1:2
            ...
            load(['../../data/Figure 11_12_13/',fig_name])
            ...
            legend(hPlot, 'LU','LO','QU','QO','location','northeast');
            
            set_axis_param
            set_fonts
            saveas(fig,['../../figs/Figure 11_12_13/',fig_name],'epsc');
